...
export const HighImpactHero: React.FC<Page['hero']> = ({ title, media, richText, sponsors }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="container relative z-[2] flex flex-col items-center text-center px-4 pt-4 min-h-[80vh]">
        <div className="flex-1 flex flex-col items-center justify-center">
          <h1 className="text-4xl md:text-4xl font-bold uppercase mb-8 max-w-4xl mx-auto">
            {title}
          </h1>
