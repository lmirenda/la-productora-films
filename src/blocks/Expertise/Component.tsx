...
export const ExpertiseBlock: React.FC<ExpertiseBlockProps> = () => {
  const expertiseItems = [
    {
      icon: <Clapperboard className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
    ...
    {
      icon: <Map className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
    ...
    {
      icon: <Camera className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
    ...
    {
      icon: <Users className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
    ...
    {
      icon: <Truck className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
    ...
    {
      icon: <Film className="w-8 h-8 md:w-10 md:h-10 text-[#FF4D00]" />,
