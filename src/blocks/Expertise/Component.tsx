...
export const ExpertiseBlock: React.FC<ExpertiseBlockProps> = () => {
  return (
    <div className="bg-black text-white py-8 md:py-16 px-8 md:px-20 font-avenir">
      <div className="max-w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[465px_1fr] gap-8 md:gap-[120px] mb-8 md:mb-16">
          ...
          <div>
            ...
            <div className="text-[20px] md:text-[24px] font-[600] mb-2 md:mb-8 leading-[26px] md:leading-[30px]">
              Cash Rebates.
              <br />
          ...
          <div>
            ...
            <div className="mb-6 md:mb-8">
              <p className="text-[14px] md:text-[16px] font-[400] leading-normal text-justify mb-8 md:mb-6">
        ...
        {/* Bottom Section */}
        <div className="grid grid-cols-1 md:grid-cols-[465px_1fr] gap-8 md:gap-[120px]">
          {/* Left Column */}
          <div>
            <div className="border-t border-white w-full mb-8"></div>
            <div className="text-[20px] md:text-[24px] font-[600] mb-2 md:mb-8 leading-[26px] md:leading-[30px]">
